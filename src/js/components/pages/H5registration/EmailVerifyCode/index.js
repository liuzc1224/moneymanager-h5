...
class SendEmailVerifyCode extends Component{
    constructor(props){
        super(props)
        this.state={
            count:0,
    ...
    render(){
        ...
        return(
            ...
            >{
                ...
                // counting? <span style={{color:'red'}}>{count}s</span> :'Enviar'
            }</button>
        )

    }
}
SendEmailVerifyCode.propTypes = {
    isSend: PropTypes.bool.isRequired,
    onhandlePhone: PropTypes.func.isRequired,
    onSuccessSend: PropTypes.func.isRequired
}

SendEmailVerifyCode.defaultProps = {
    isSend: false
}
